...
maximal ein Cache erlaubt. Ein neuer Inhalt ersetzt den alten untrusted-Verweis
atomar; das alte Asset wird nur gelöscht, wenn es nicht mehr anderweitig
referenziert wird. `strict-save` steuert weiterhin nur Save-Fehler. Shared- und
Trusted-Caches werden bei einer Aktualisierung ebenfalls ersetzt.
